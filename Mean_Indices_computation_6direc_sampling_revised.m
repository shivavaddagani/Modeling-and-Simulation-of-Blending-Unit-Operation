...
total_time=180; %sec  %to be specified
rotation_speed=12.0/60.0 % rps  12rpm % to be specified
sample_data=1e5; % evry 100000 step data collected
no_samples=total_time*rotation_speed
...
p=0.7;% proportion of material A 
...
table=[MI(nd1,:)', ML(nd1,:)', MP(nd1,:)', floor(Na(nd1,:))', floor(Nb(nd1,:))', RSD(nd1,:)', RSDr(nd1,:)', sigma_square(nd1,:)', sigmaR_square(nd1,:)']
